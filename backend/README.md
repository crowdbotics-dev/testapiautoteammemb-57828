...
## Project Structure
    ...
    ├── testapiautoteammemb_57828  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_57828`
...
2. Clone this repo and `cd testapiautoteammemb_57828`
